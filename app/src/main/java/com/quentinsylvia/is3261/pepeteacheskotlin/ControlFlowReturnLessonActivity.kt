...
class ControlFlowReturnLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_control_flow_return_lesson)

        viewPager = findViewById(R.id.return_viewpager)
        pagerAdapter = ControlFlowReturnLessonPagerAdapter(supportFragmentManager)
    ...
    private fun finishReturnLesson() {
