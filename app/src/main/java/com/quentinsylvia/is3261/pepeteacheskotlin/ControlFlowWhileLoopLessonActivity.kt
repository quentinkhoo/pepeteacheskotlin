...
class ControlFlowWhileLoopLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_control_flow_while_loop_lesson)

        viewPager = findViewById(R.id.while_loop_viewpager)
        pagerAdapter = ControlFlowWhileLoopLessonPagerAdapter(supportFragmentManager)
    ...
    private fun finishWhileLoopLesson() {
