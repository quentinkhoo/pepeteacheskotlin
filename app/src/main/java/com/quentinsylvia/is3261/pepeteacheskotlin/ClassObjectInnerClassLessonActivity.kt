...
class ClassObjectInnerClassLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_class_object_inner_class_lesson)

        viewPager = findViewById(R.id.innerclass_viewpager)
        pagerAdapter = ClassObjectInnerClassLessonPagerAdapter(supportFragmentManager)
