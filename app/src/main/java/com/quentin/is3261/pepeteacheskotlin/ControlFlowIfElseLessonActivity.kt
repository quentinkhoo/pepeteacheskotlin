...
class ControlFlowIfElseLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_control_flow_if_else_lesson)

        viewPager = findViewById(R.id.ifelse_viewpager)
        pagerAdapter = ControlFlowIfElseLessonPagerAdapter(supportFragmentManager)
