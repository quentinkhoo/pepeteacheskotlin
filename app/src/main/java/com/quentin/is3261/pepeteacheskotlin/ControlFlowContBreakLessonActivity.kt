...
class ControlFlowContBreakLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_control_flow_cont_break_lesson)

        viewPager = findViewById(R.id.contbreak_viewpager)
        pagerAdapter = ControlFlowContBreakLessonPagerAdapter(supportFragmentManager)
