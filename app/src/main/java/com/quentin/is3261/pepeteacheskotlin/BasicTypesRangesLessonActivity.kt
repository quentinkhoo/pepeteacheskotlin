...
class BasicTypesRangesLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_basic_types_ranges_lesson)


        viewPager = findViewById(R.id.ranges_viewpager)
        pagerAdapter = BasicTypesRangesLessonPagerAdapter(supportFragmentManager)
    ...
    private fun finishCharacterLesson() {
        ...
        Toast.makeText(this, "You have finished Ranges Lesson!", Toast.LENGTH_LONG).show()
