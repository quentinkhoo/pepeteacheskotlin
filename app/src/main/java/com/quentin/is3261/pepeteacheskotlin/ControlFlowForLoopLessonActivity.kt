...
class ControlFlowForLoopLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_control_flow_for_loop_lesson)

        viewPager = findViewById(R.id.for_loop_viewpager)
        pagerAdapter = ControlFlowForLoopLessonPagerAdapter(supportFragmentManager)
    ...
    private fun finishForLoopLesson() {
