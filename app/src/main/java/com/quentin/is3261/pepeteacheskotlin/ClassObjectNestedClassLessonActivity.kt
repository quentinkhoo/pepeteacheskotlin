...
class ClassObjectNestedClassLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_class_object_nested_class_lesson)

        viewPager = findViewById(R.id.nestedclass_viewpager)
        pagerAdapter = ClassObjectNestedClassLessonPagerAdapter(supportFragmentManager)
