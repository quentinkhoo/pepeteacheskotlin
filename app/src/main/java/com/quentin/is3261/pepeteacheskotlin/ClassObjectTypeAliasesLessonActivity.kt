...
class ClassObjectTypeAliasesLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_class_object_type_aliases_lesson)
        viewPager = findViewById(R.id.typealiases_viewpager)
        pagerAdapter = ClassObjectTypeAliasesLessonPagerAdapter(supportFragmentManager)
    ...
    private fun finishContBreakLesson() {
        sharedPreferences.set("ContBreak", true)
        Toast.makeText(this, "You have finished Nested Class lesson!", Toast.LENGTH_LONG).show()
